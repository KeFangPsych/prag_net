...
// ============================================================================
// To collect data, create a project at https://pipe.jspsych.org/, paste your
// experiment ID below, and set `enabled: true`. See README.md for full setup.
const DATAPIPE_CONFIG = {
  experiment_id: "REPLACE_WITH_YOUR_DATAPIPE_EXPERIMENT_ID",
  // Default false on a fresh clone so accidental loads don't try to write
  // to a misconfigured project. Flip to true when ready to collect data.
  enabled: false,
};
